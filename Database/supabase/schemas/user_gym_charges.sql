...
CREATE TABLE user_gym_charges (
    ...
    refunds_charge_id UUID
        ...
        REFERENCES user_gym_charges(charge_id),
...
CREATE INDEX idx_charges_invoice
    ON user_gym_charges (invoice_id);

CREATE INDEX idx_charges_user_gym_time
    ON user_gym_charges (crm_user_id, gym_id, charge_time DESC);

CREATE INDEX idx_charges_gym_time
    ON user_gym_charges (gym_id, charge_time DESC);
