...
CREATE INDEX idx_member_memberships_member ON public.member_memberships_unfiltered USING btree (member_id);

CREATE INDEX idx_members_account_linked_to ON public.members USING btree (account_linked_to_id) WHERE (account_linked_to_id IS NOT NULL);
