alter table "public"."member_memberships" drop constraint "fk_membership_linked_account_same_gym";
...
alter table "public"."gym_discounts" add column "discount_active" boolean not null default true;

alter table "public"."gym_discounts" add column "discount_type" character varying not null;

alter table "public"."member_memberships" drop column "account_linked_to_id";

alter table "public"."member_memberships" drop column "custom_discounts";

alter table "public"."membership_plans" drop column "additional_member_costs";

alter table "public"."membership_plans" add column "additional_member_discount" double precision;
...
alter table "public"."membership_plans" add constraint "membership_plans_additional_member_discount_check" CHECK (((additional_member_discount > (0)::double precision) AND (additional_member_discount < (100)::double precision))) not valid;

alter table "public"."membership_plans" validate constraint "membership_plans_additional_member_discount_check";
