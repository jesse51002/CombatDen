...
CREATE UNIQUE INDEX gyms_owner_id_key ON public.gyms USING btree (owner_id);
...
alter table "public"."gyms" add constraint "gyms_owner_id_key" UNIQUE using index "gyms_owner_id_key";
