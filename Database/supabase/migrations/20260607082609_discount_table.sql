revoke delete on table "public"."resource_locks" from "authenticated";

revoke insert on table "public"."resource_locks" from "authenticated";

revoke references on table "public"."resource_locks" from "authenticated";

revoke select on table "public"."resource_locks" from "authenticated";

revoke trigger on table "public"."resource_locks" from "authenticated";

revoke truncate on table "public"."resource_locks" from "authenticated";

revoke update on table "public"."resource_locks" from "authenticated";
...
alter table "public"."member_invoice_applied_discounts" alter column "discount_id" drop not null;

alter table "public"."member_invoice_applied_discounts" alter column "stripe_coupon_id" set not null;

CREATE UNIQUE INDEX uq_applied_discount_invoice_coupon ON public.member_invoice_applied_discounts USING btree (invoice_id, stripe_coupon_id);

alter table "public"."member_invoice_applied_discounts" add constraint "uq_applied_discount_invoice_coupon" UNIQUE using index "uq_applied_discount_invoice_coupon";
