create type "public"."stripe_onboarding_status" as enum ('not_started', 'pending', 'complete', 'disabled');

alter table "public"."gyms" drop constraint "gyms_stripe_onboarding_status_valid";
...
alter table "public"."gyms" alter column "stripe_onboarding_status" set default 'not_started'::public.stripe_onboarding_status;

alter table "public"."gyms" alter column "stripe_onboarding_status" set data type public.stripe_onboarding_status using "stripe_onboarding_status"::public.stripe_onboarding_status;
