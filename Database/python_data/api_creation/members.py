...
Linked children POST with no card (the seed only creates parent-paid
families — every child's memberships ride the parent's subscription); they
still get a cardless Stripe customer, and the parent pays.
