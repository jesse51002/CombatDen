...
def seed() -> None:
    ...
    for i, bundle in enumerate(bundles):
        ...
        with login_gym_owner(bundle.owner_email, DEFAULT_PASSWORD) as api:
            ...
            print(f"Creating {len(member_plans)} members via API...")
        ...
        bs_activities.create(client, gym_id, members)
        ...
        if result.had_any_new:
            ...
            print(f"  {len(inv)} invoices, {len(li)} line items, {len(ch)} charges")
