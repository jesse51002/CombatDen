...
const String _kCreatorPfp = 'assets/images/video_creator_pfp.png';
...
const List<MockVideo> mockVideos = [
  MockVideo(
    ...
    thumbnailAsset: 'assets/images/video_thumb_self_defense.png',
  ...
  MockVideo(
    ...
    creatorName: 'Rokas Leo',
    creatorPfpAsset: _kCreatorPfp,
    thumbnailAsset: 'assets/images/video_thumb_boxing_ring.png',
    viewsLabel: '350K views',
    sponsorLabel: 'USDC',
  ...
  MockVideo(
    ...
    creatorName: 'Rokas Leo',
    creatorPfpAsset: _kCreatorPfp,
    thumbnailAsset: 'assets/images/video_thumb_netflix_red.png',
    viewsLabel: '350K views',
    sponsorLabel: 'USDC',
    category: 'Your Next Watch',
  ),
  MockVideo(
    ...
    creatorName: 'Rokas Leo',
    creatorPfpAsset: _kCreatorPfp,
    thumbnailAsset: 'assets/images/video_thumb_muay_thai_pad.png',
    viewsLabel: '350K views',
    sponsorLabel: 'USDC',
  ...
  MockVideo(
    ...
    creatorName: 'Rokas Leo',
    creatorPfpAsset: _kCreatorPfp,
    thumbnailAsset: 'assets/images/video_thumb_krav_maga_specs.png',
    viewsLabel: '350K views',
    sponsorLabel: 'USDC',
    category: 'Level up your skills',
  ),
  MockVideo(
    ...
    creatorName: 'Rokas Leo',
    creatorPfpAsset: _kCreatorPfp,
    thumbnailAsset: 'assets/images/video_thumb_netflix_fight.png',
    viewsLabel: '350K views',
    sponsorLabel: 'USDC',
  ...
  MockVideo(
    ...
    creatorName: 'Rokas Leo',
    creatorPfpAsset: _kCreatorPfp,
    thumbnailAsset: 'assets/images/video_thumb_krav_skit.png',
    viewsLabel: '350K views',
    sponsorLabel: 'USDC',
...
const MockVideo mockDrillOfTheDay = MockVideo(
  ...
  creatorName: 'Rokas Leo',
  creatorPfpAsset: _kCreatorPfp,
  thumbnailAsset: 'assets/images/summary_drill_video.png',
  viewsLabel: '350K views',
  sponsorLabel: 'USDC',
...
const MockVideo mockVideoBeforeClass = MockVideo(
  ...
  creatorName: 'Rokas Leo',
  creatorPfpAsset: _kCreatorPfp,
  thumbnailAsset: 'assets/images/video_thumb_before_class.png',
  viewsLabel: '350K views',
  sponsorLabel: 'USDC',
...
const List<MockVideo> mockFightingLessons = [
  MockVideo(
    ...
    creatorName: 'Rokas Leo',
    creatorPfpAsset: _kCreatorPfp,
    thumbnailAsset: 'assets/images/video_thumb_gym_questions.png',
    viewsLabel: '350K views',
    sponsorLabel: 'USDC',
  ...
  MockVideo(
    ...
    creatorName: 'Rokas Leo',
    creatorPfpAsset: _kCreatorPfp,
    thumbnailAsset: 'assets/images/video_thumb_muay_thai_title.png',
    viewsLabel: '350K views',
    sponsorLabel: 'USDC',
    category: 'Fighting Lessons',
  ),
  MockVideo(
    ...
    creatorName: 'Rokas Leo',
    creatorPfpAsset: _kCreatorPfp,
    thumbnailAsset: 'assets/images/video_thumb_muay_thai_drills.png',
    viewsLabel: '350K views',
    sponsorLabel: 'USDC',
    category: 'Fighting Lessons',
  ),
  MockVideo(
    ...
    creatorName: 'Rokas Leo',
    creatorPfpAsset: _kCreatorPfp,
    thumbnailAsset: 'assets/images/video_thumb_shadow_boxing.png',
    viewsLabel: '350K views',
    sponsorLabel: 'USDC',
    category: 'Fighting Lessons',
  ),
