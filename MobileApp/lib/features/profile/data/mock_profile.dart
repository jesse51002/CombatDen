...
const mockProfileGlobalMma = MockProfile(
  ...
  rankBadgeLargeAsset: 'assets/images/profile_rank_belt_gold.png',
  ratingGraphAsset: 'assets/images/profile_rating_graph.png',
  nextRankTitle: 'Next Rank',
  nextRankProgressLabel: 'Silver I (23/50 classes)',
  nextRankProgress: 0.55,
  nextRankBadgeAsset: 'assets/images/profile_next_rank_belt.png',
  levelUpVideos: [
    MockProfileVideo(
      title: 'Mauy Thai Basics (Don’t look lik)',
      viewCount: '350K views',
      thumbnailAsset: 'assets/images/profile_video_thumb.png',
      creatorAvatarAsset: 'assets/images/profile_creator_pfp.png',
    ),
    MockProfileVideo(
