...
import 'package:mobile_app/features/home/presentation/widgets/photo_verification/photo_verification_card.dart';
...
const double _kPhotoVerificationCardHeight = 200;
...
// regular components of the pre-schedule height — there are 3 inter-section
// gaps (topbar→cards, between cards, cards→title) before the date row.
const double _kPreScheduleHeight =
    _kTopbarHeight +
    _kSectionGap +
    _kPhotoVerificationCardHeight +
    _kSectionGap +
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Column(
        ...
        crossAxisAlignment: CrossAxisAlignment.stretch,
        spacing: _kSectionGap,
        children: const [PhotoVerificationCard(), UpcomingSessionsCard()],
      ),
    );
  }
}
