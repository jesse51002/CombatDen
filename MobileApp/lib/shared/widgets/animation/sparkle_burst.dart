...
/// Used behind the trophy/illustration on the post-class points and wins
/// screens. Distinct from `SparkleHero` (which is the system signature for
/// streak/points/rank text) — that component's rationing rule still holds.
