...
/// Read-only Waivers section on the member-detail page: every
/// gym waiver and this member's sign status for each. Fetches
/// directly (read-only) via [MembershipsRepository]; the actual
/// front-desk signing capture is a separate (Phase 2) flow.
