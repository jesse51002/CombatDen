...
/// Response from `POST /api/v1/members/{member_id}/link/check`.
///
/// Mirrors the merged `MembersBillingLinkCheckResponse`
/// schema. `error` is a pre-formatted, user-facing string
/// — render it as-is when `canLink` is false.
@JsonSerializable(
