...
class VideoConfigInputBar extends StatefulWidget {
  ...
  @override
  State<VideoConfigInputBar> createState() => _VideoConfigInputBarState();
}

class _VideoConfigInputBarState extends State<VideoConfigInputBar> {
