...
/// (`GET /api/v1/presets/templates/{gymId}`).
///
...
class GymApiClient {
  ...
  /// `GET /api/v1/presets/templates/{gymId}` — the template's whole content
  ...
  Future<GymDetail> fetchGym(String gymId) async {
    final uri = Uri.parse('$baseUrl/api/v1/presets/templates/$gymId');
