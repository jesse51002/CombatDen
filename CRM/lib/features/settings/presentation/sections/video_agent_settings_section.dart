...
/// Settings section that links to the video-agent screen.
///
/// The owner taps "Configure video feed" to open [VideoAgentScreen], where
/// they chat with an agent to author their gym's keep/avoid criteria and
/// YouTube search queries.
class VideoAgentSettingsSection extends StatelessWidget {
  const VideoAgentSettingsSection({super.key});
...
class _Description extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Text(
      ...
      'proposes a spec you review and confirm before it takes effect.',
