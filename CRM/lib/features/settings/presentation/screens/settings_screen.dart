...
import 'package:crm/features/settings/presentation/sections/video_agent_settings_section.dart';
...
///   2. Sign-up QR codes — the printable front-desk codes (moved here from the
///      nav rail)
///
/// Backed by a small [SettingsBloc] (the theme save talks to the backend); the
/// selected theme itself lives in `themeController` and drives the whole app.
