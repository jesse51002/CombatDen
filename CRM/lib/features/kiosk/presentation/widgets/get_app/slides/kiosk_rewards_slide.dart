...
/// Slide 2 — "Earn rewards": the gym's own reward catalogue as the 2x2 grid
/// (mockup `.rsw-grid`).
///
...
/// rewards (or a failed fetch) omits it entirely rather than showing the
/// mockup's demo rewards, so [rewards] here is always populated.
