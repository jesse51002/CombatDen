...
/// Employees list body — the stateless mock employees surface, rendered as the
/// Employees tab of the People screen.
///
/// Composition (top to bottom), matching the Members body so the two read as
/// siblings under the People screen's top toggle:
