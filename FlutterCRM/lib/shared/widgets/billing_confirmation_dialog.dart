...
/// A single bullet describing an effect of the pending
/// billing action (e.g. "$50.00 charged to Visa ••••
/// 4242" or "Billing paused for 3 months").
class BillingEffect {
  final IconData icon;
  final String text;
...
/// Person affected by the billing action.
...
/// Shared final-step confirmation for any action that
/// moves money, pauses billing, or changes what a member
/// gets charged. Presents a consistent summary: lead
/// sentence, bulleted effects, optional affected-people
/// list, optional warning, confirm + cancel. Returns
/// `true` iff the user confirmed.
      ...
      children: [
        ...
        if (effects.isNotEmpty)
          Column(
            ...
            children: effects
                .map((e) => _EffectRow(effect: e))
                .toList(),
          ),
        if (affected.isNotEmpty)
          _AffectedList(people: affected),
        if (warning != null)
