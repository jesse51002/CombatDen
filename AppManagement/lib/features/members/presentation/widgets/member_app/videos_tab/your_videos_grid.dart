...
/// The "Your videos" View all view: every upload in a reflowing grid, with the
/// "Add custom video" action at the top — Your videos is the one feed section
/// the gym adds to, so the add affordance leads it.
class YourVideosGrid extends StatelessWidget {
  const YourVideosGrid({super.key});
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        VideoWrapGrid(tiles: buildYourVideoTiles()),
      ],
    );
  }
}
