...
import 'package:app_management/features/members/presentation/widgets/table/cells/member_rank_cell.dart';
import 'package:app_management/shared/widgets/app_data_table.dart';

/// Members table — Name / Contact / Rank / Last Class columns.
///
  ...
  Widget build(BuildContext context) {
    return AppDataTable(
      ...
      columns: const [
        ...
        AppDataTableColumn(label: 'Rank', minWidth: 140, fill: true),
