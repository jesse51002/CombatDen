...
DOMAIN = "themes.combatden.net"
BUCKET = "combatden-themes"
REGION = "us-east-1"
PROJECT_TAG = "combatden-themes"

DEPLOY_DIR = Path(__file__).resolve().parent
# The built Flutter web bundle (deploy-themes/ lives under AppManagement/).
# This is the SAME build/web directory the admin deploy uses, so the two deploys
# are sequential: build the theme-browser target first, then upload here.
# Produced by: make build-themes →
