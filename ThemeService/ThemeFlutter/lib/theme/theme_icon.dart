...
import 'package:theme_flutter/theme/engine_tokens.dart';
...
class ThemeIcon {
  ...
  static Widget widget(
    ...
    double size = EngineTokens.iconSizeMd,
    Color? color,
    double? weight,
  }) {
    final tint =
        ...
        ThemeColor.token('text', fallback: EngineTokens.fallbackIconColor);
    final fallbackIcon = Icon(
      fallback,
      size: size,
      color: tint,
      weight: weight ?? EngineTokens.iconWeight,
    );
