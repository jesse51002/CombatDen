...
class ThemeColor {
  ...
  static Color color(
    ...
    final slot = getIt<ThemeService>().current?.colors[key];
  ...
  static Color paletteEntry(
    ...
    return getIt<ThemeService>().current?.palette[key] ?? fallback;
  }
  ...
  static Color token(
    ...
    final current = getIt<ThemeService>().current;
  ...
  static ColorMode mode({
    ...
    return getIt<ThemeService>().current?.colorMode ?? fallback;
  }
}
