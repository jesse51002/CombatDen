...
import 'package:theme_flutter/theme/fallback_image_provider.dart';
...
/// the ThemeService is a pure live override. The caller
...
class ThemeImage {
  ...
  static ImageProvider image(String slot, {required ImageProvider fallback}) {
    if (!getIt.isRegistered<ThemeService>()) return fallback;
    ...
    // The ThemeService is a best-effort live override: if these
