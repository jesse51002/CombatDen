...
| `gyms` | Gym records + Stripe **Connect** Express onboarding + the gym's persisted ThemeService design choice (`PUT /{gym_id}/theme` → `gyms.theme_design_id`, mirroring the employee theme-preference save) |
