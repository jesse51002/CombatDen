...
-- only sets cancel_date — cancel never uses 'migrating') until the writeback
-- stamps 'deleted'; a price migration stages 'migrating' then the writeback stamps
-- 'applied'. The verify must read the unfiltered base because the client-facing
