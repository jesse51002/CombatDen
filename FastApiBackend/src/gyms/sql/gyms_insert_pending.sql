...
INSERT INTO gyms (gym_name, gym_description, address, timezone)
VALUES (:gym_name, :gym_description, :address, :timezone)
RETURNING gym_id, gym_name, gym_description, address, timezone,
