"""API settings — where the per-company briefs live, plus CORS, from env / `.env`."""
...
# This file is <root>/src/api/config.py; briefs live in <root>/apps.
...
class Settings(BaseSettings):
    ...
    # Root that holds `<app_id>/videos_config.yaml`.
